...
import bottom_banner_image from "./bottom_banner_image.mp4";
...
import soundFile from "../assets/applepay.mp3";
import buySound from "./buy_1.mp3";
...
{
  text: "Hospital Seminars",
  path: "Hospital Seminars",
  image: dairy_product_image,
  bgColor: "#FEE6CD",
},
{
  text: "Awareness Programs",
  path: "Awareness Programs",
  image: bakery_image,
  bgColor: "#E0F6FE",
},
{
  text: "Corporate Health Events",
  path: "Corporate Health Events",
  image: grain_image,
  bgColor: "#F1E3F9",
},
...
export const features = [
  { title: "Seamless Event Scheduling", description: "Plan and manage medical conferences, health camps, and hospital events efficiently.", }, { title: "Healthcare-Focused Planning", description: "Designed specifically for hospitals, doctors, and healthcare institutions.", }, { title: "Cost-Effective Management", description: "Reduce paperwork and operational costs through smart digital workflows.", }, { title: "Trusted by Healthcare Teams", description: "Used confidently by hospital administrators, doctors, and medical staff.", }, { title: "Automated Event Notifications", description: "Send timely reminders and updates to staff and participants automatically.", }, { title: "Secure Medical Data Handling", description: "Ensure data privacy and security with hospital-grade protection standards.", },
];
